...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertItem() {
        ...
        // and CubeSat's attributes are the values.
        ContentValues values = new ContentValues();
        values.put(ItemContract.ItemEntry.COLUMN_PRODUCT_NAME, getString(R.string.sk_cube));
        values.put(ItemContract.ItemEntry.COLUMN_PRICE, getString(R.string.price));
        values.put(ItemContract.ItemEntry.COLUMN_QUANTITY, getString(R.string.quantity));
        values.put(ItemContract.ItemEntry.COLUMN_SUPPLIER_NAME, getString(R.string.supplier_name));
        values.put(ItemContract.ItemEntry.COLUMN_PHONE_NUMBER, getString(R.string.supplier_phone));
        values.put(ItemContract.ItemEntry.COLUMN_DESCRIPTION, getString(R.string.description));
        ...
        // Receive the new content URI that will allow us to access SKCube's data in the future.
    ...
    private void deleteAllItems() {
        ...
        Log.v("CatalogActivity", rowsDeleted + " rows deleted form item database");
    }
